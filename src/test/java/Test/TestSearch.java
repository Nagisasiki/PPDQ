...
public class TestSearch {
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException, InterruptedException {
        ...
        //生成查询陷门
        DistriMap distriMap = new DistriMap(1,"E:\\lpy\\datasets\\public\\distributions\\Distribution_1.txt");
        GenQuery genQuery = new GenQuery(distriMap,3);



        /*//初始化数据集
        SecureDataset secureDataset = new SecureDataset(datasetName, path,secureInnerProductCalculator,200000);
        ArrayList<SecureSimilarIndex> secureSimilarIndices = secureDataset.getIndices();
        //secureDataset.printDataset();

        SecureDistriMap secureDistriMap = new SecureDistriMap(1,"E:\\lpy\\datasets\\public\\distributions\\Distribution_1.txt");
